...
router.put("/addServices/:email", (req, res, next) => {
	// console.log(req.body)
	if (req.body.meal) {
...
// View All staff
router.get("/home/get/staff", (req, res, next) => {
	// console.log("Inside");
	const options = {
...
// View All customers
router.get("/home/get/customer", (req, res, next) => {
	// console.log("Inside");
	const options = {
		page: +req.query.page || 1,
		limit: +req.query.limit || 20,
...
router.put("/home/edit/:email", (req, res, next) => {
	// console.log(req.body);
	...
	UserModel.findOne({ email: req.emailUser.email })
		.then((updateUser) => {
			...
			if (req.body.allocatedBedNum) {
				BedModel.findOne({ bedNum: +req.emailUser.allocatedBedNum })
					.then((userBed) => {
						// console.log(userBed);
						userBed.isFree = true;
...
router.delete("/delUser/:email", async (req, res, next) => {
